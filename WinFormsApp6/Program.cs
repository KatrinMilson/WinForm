...
n.Nodes.Add(new TreeNode("Button"));
        ...
        // Обработчик событий, срабатывающий при выборе одного из узлов
        //  дерева TreeView 
        ...
        (object sender, System.Windows.Forms.TreeViewEventArgs e)
        {
            ...
            else if (e.Node.Text == "Label")
            {
                ...
                label1.Text = "Это надпись. Используется для вывода текста на экран!";
            ...
            else if (e.Node.Text == "TextBox")
            {
                ...
                textBox1.Multiline = true; textBox1.Text = "Это текстовое окно. Сюда можно вводить текст!" + "\r\n" + " Сотрите этот текст и введите свой!";
            ...
            else if (e.Node.Text == "TabControl")
            {
                ...
                labelС.Text = "Это компьютер Вадика! Пока Вадик купается, " + "он разрешает работать на компьютере ящерице!";
                ...
                labelT.Text = "Это страна Компьютерия!" + " Она расположена на берегу реки Тверца в Тверской области!";
            ...
            else if (e.Node.Text == "PictureBox")
            {
                ...
                PictureBox pictureBox1 = new PictureBox();
                pictureBox1.Image = new Bitmap("C:\\Users\\satoa\\OneDrive\\Изображения\\");
            ...
            else if (e.Node.Text == "MainMenu")
            {
                ...
                this.Menu = mainMenu1;
                MessageBox.Show("Главное меню добавлено в окно " + "Испытайте его после нажатия OK.");
            }
        ...
        /* Обработчики событий для добавленных выше элементов управления */ // Обработчик события, срабатывающий при щелчке мышью на метке 
        void label1_Click(object sender, System.EventArgs e)
        {
            MessageBox.Show("Да, у меток тоже есть событие Click. Но для них включение событий - редкость.");
        }
        ...
        void CheckBox_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            else { MessageBox.Show("Ни скромности, ни таланта?"); }
        }
        ...
        void RadioButton_CheckedChanged(object sender, System.EventArgs e)
        {
            ...
            else if (radioButton2.Checked) { MessageBox.Show("Это замечательно!"); }
        }
        ...
        {
            if (MessageBox.Show("Вы уверены, что хотите закончить работу?",
        ...
        {
            if (e.Button.Text == "Open") { MessageBox.Show("Здесь мог бы открываться файл!"); }
