...
class FormWithManyControls : Form
{
    ...
    private void treeView1_AfterSelect (object sender, TreeViewEventArgs e)
    {
        ...
        else if (e.Node.Text == "ToolBar")
        {
            ...
            toolBar1.ButtonClick += toolBar1_Click;
    ...
    {
        if (MessageBox.Show("Вы уверены, что хотите закончить работу?", "Exit confirmation", MessageBoxButtons.YesNo) == DialogResult.Yes)
        {
            this.Dispose();
        }
    }
    ...
    void toolBar1_Click (object sender, ToolBarButtonClickEventArgs e)
    {
